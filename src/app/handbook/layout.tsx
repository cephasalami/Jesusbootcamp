...
export const metadata: Metadata = {
    ...
    description: "Download your free copy of the Handbook for a Disciple of Jesus by Paul Joseph. Thousands of scripture references organized by life topic. Used by teachers, preachers, and churches worldwide.",
    openGraph: {
